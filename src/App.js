      ...
      <div className="container">
        <div className="row">
          ...
          <div className="experience-item mb-4">
              <span className="date"><span className="icon-calendar"></span> 2005-present</span>
              ...
              <div className="card h-100 dj-history">
                ...
                <div className="dj-history-text">
                  ...
                  <ul>
                    ...
                    <li className="site-check"><a href="https://www.mixcloud.com/irisberkeley/playlists/modern-jetset/" target="_blank" rel="noopener noreferrer">Modern Jetset</a> weekly freeform show, <a href="https://www.radiorethink.com/index.cfm/fuseaction/rr.page/pageID/projects-channelone-eclectic.html" target="_blank" rel="noopener noreferrer">Radio Rethink</a></li>
                    <li className="site-check"><a href="https://www.mixcloud.com/irisberkeley/playlists/signalling-system/" target="_blank" rel="noopener noreferrer">Signalling System</a> weekly freeform show, KVCU <a href="http://www.radio1190.net" target="_blank" rel="noopener noreferrer">Radio 1190</a></li>
